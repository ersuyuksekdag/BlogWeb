...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">Projeler/Sertifikalar</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="awards">
        <div class="w-100">
            <h2 class="mb-5">PROJELER/SERTİFAKALAR</h2>
                ...
                <ItemTemplate>
                    <ul class="fa-ul mb-0">
                        <li>
                            ...
                            <asp:Label ID="Label17" runat="server" Text='<%# Eval("PROJELER") %>'>'></asp:Label>
                    </ul>
